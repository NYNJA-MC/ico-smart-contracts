...
contract('NYNJACoin', function ([_, owner, recipient, anotherAccount, assigner, locker]) {
    const ZERO_ADDRESS = '0x0000000000000000000000000000000000000000';

    beforeEach(async function () {
        this.token = await NYNJACoin.new(assigner, locker);
        await this.token.tokenSaleStart();
        await this.token.mint(owner, 100, { from: assigner });
        await this.token.tokenSaleEnd();
    });
